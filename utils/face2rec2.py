...
if __name__ == '__main__':
    ...
    if args.list:
        ...
        prop = edict()
        prop.num_classes = len(os.listdir(working_dir))
        prop.image_size = [112, 112]
        ...
        files = [os.path.join('temp', fname) for fname in os.listdir('temp')
                    if os.path.isfile(os.path.join('temp', fname))]
        count = 0
        for fname in files:
